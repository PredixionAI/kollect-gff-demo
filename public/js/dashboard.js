...
function steps(){
  ...
  { tab:'b360', pill:'Step 2/13', title:'Signal Aggregation', subtitle:'Pulling structured + behavioral data across systems',
    ...
    live:{type:'terminal', tag:'AGGREGATING SIGNALS', voice:false, lines:['Repayment history: 18 EMIs paid on time','Autopay mandate: active, one bounce this cycle','Channel preference: WhatsApp, replies within a day','App usage: daily active','','Classifying borrower...']},
    agents:['Data Orchestration Agent','Classification Agent'], models:['Feature Extraction','Behavioral Scoring Model'],
    signals:[{name:'LMS', tag:'history', desc:'18 of 18 EMIs on time before this cycle'},{name:'Autopay', tag:'mandate', desc:'NACH active, one bounce this cycle'},{name:'App Analytics', tag:'engagement', desc:'Daily active, WhatsApp preferred'}],
  },
